...
#				SUBSET MOOD
```{r Mood_Subset, eval=TRUE, echo=FALSE, message=FALSE, comment = ""}
...
#	1. T-test
t.test(dat1$visit1moodpre ~ dat1$group.factor, mu=0, alt="two.sided", conf=0.95, var.eq=F, paired=F)
...
attach(dat2)
boxplot(dat2$visit1moodpre ~ dat2$group)

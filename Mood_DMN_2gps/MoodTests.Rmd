...
# dat3 <- dat1 %>% dplyr::select("ID", "group.factor",
# 							   "v1.mood", "v2.mood",
# 							   "visit1moodpre", "visit1moodpost",
# 							   # contains("mood")
# 							   "visit2moodpre", "visit2moodpost",
...
ggboxplot(full_dat, x = "group", y = "pos_pre", 
          color = "group", palette = c("#00AFBB", "#E7B800", "#FC4E07"),
          order = c("HC", "CLBP", "FM"),
          ylab = "Baseline mood", xlab = "Group")
